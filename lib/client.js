...
//#region lib/client/archive-locale.js
/**
...
function tFallback(key, vars) {
	const template = ARCHIVE_LOCALE[LANG][key] ?? key;
	...
	return (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			(0, react_jsx_runtime.jsx)("span", {
				...
				children: timeAgo(item.updatedAt ?? item.createdAt, tr)
			}),
			(0, react_jsx_runtime.jsx)("span", {
...
function ArchiveView({ t, onClose, onOpenSession }) {
		...
		children: [
			...
			(0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					total === 0 && (0, react_jsx_runtime.jsx)("div", {
						...
						children: tr("noArchivedSessions")
					}),
			...
			menu && (0, react_jsx_runtime.jsx)(ContextMenu, {
				...
				items: [
					...
					{
						id: "unarchive",
						label: tr("restoreSession")
					},
					{
						id: "delete",
						label: tr("deleteSession"),
						danger: true
					}
				],
				onPick: onMenuPick,
			...
			(0, react_jsx_runtime.jsxs)(_deepseek_ai_dsh_client_ui_primitives.Modal, {
				...
				description: deleteTarget !== null ? tr("deleteDescription", { title: deleteTarget.title }) : void 0,
				footer: (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
					variant: "outline",
					disabled: deleting,
					onClick: closeDelete,
...
//#endregion
//#region lib/client/session-id-badge.js
const STYLES = {
	badge: {
		display: "inline-flex",
		alignItems: "center",
...
function apply(ctx) {
	...
	*  used for DOM elements outside the React tree (tooltips, aria-labels). */
	function tFallback(key) {
		const lang = (ctx.locale?.getLocale?.()?.active ?? "en").startsWith("zh") ? "zh" : "en";
		return ARCHIVE_LOCALE[lang]?.[key] ?? key;
	}
	let tipTimer = null;
	let tipEl = null;
